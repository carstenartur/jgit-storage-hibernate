...
create unique index uk_git_sec_principal_login
    on git_security_principal (login_name)
    where login_name is not null;
create unique index uk_git_sec_principal_external
    on git_security_principal (external_issuer, external_subject)
