...
class CorePostgreSqlSchemaMigrationIntegrationTest {

  private static final AtomicInteger TEST_COUNTER = new AtomicInteger();
  private static final String POSTGRESQL_LEGACY_SCHEMA =
      "/db/legacy/jgit-storage-hibernate/core/0.1.4/postgresql/schema.sql";

  @Container
  static final PostgreSQLContainer<?> POSTGRESQL =
      new PostgreSQLContainer<>("postgres:17.10-alpine")
          .withDatabaseName("jgit_storage_hibernate_core")
  ...
  private static TestDatabase postgresDatabase(String purpose) throws SQLException {
    ...
    String schema = "core_migration_" + purpose + "_" + TEST_COUNTER.incrementAndGet();
