...
alter table git_packs alter column data drop not null;
...
comment on table git_pack_chunks is
    'Bounded chunks for Hibernate-backed JGit pack, index and reftable payloads';
