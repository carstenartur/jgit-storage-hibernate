...
/**
 * Cumulative repository-specific counters that complement Hibernate's SessionFactory statistics.
 *
 ...
 * outer transaction outcomes and time spent acquiring the cross-instance repository row lock. The
 * counters are thread-safe and may be sampled while the repository is active.
 */
