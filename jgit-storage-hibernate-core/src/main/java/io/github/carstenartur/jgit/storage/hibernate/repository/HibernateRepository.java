...
import io.github.carstenartur.jgit.storage.hibernate.transaction.HibernateStorageMetrics;
...
public class HibernateRepository extends DfsRepository {
  ...
  /** Return cumulative transaction, repository-lock and pack-payload metrics for this instance. */
  public HibernateStorageMetrics getStorageMetrics() {
    return transactionContext.getStorageMetrics();
  }
