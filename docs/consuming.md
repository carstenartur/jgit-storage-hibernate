...
The documented release line is **0.1.9**. It uses Java 21, Hibernate ORM 7.4.5.Final and Hibernate Search 8.4.0.Final. Keep those versions aligned through the published artifacts instead of overriding only one side of the stack.
