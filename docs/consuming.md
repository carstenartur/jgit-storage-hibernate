...
The documented release line is **0.11.2**. It uses Java 21, JGit 7.7.1.202607240634-r, Hibernate ORM 7.4.5.Final and Hibernate Search 8.4.0.Final. Keep those versions aligned through the published BOM and tested deployment stack instead of overriding only one side of the stack.
